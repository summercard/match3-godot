...
const BLESSING_TEMPLATES := [
	{"sender": "云岚", "title": "一份勇气祝福", "body": "远方的冒险者托精灵捎来一句话：愿你在下一场战斗中保持勇气。"},
	{"sender": "星芽", "title": "一封温暖来信", "body": "一只小精灵飞过你的营地，留下了陌生旅人的温柔祝福。"},
	{"sender": "潮汐旅人", "title": "来自远方的问候", "body": "远方的冒险者听说了你的旅途，愿你的伙伴始终陪在身边。"},
	{"sender": "林间邮差", "title": "精灵的祝福", "body": "一颗带着叶香的星星落进信箱，里面装着陌生人的小小心意。"},
]
