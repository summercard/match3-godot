# stage_select_logic.gd - 关卡选择界面的旧脚本逻辑父类
# 源文件: js/ui/sceneStageSelect.js
# 翻译版本: GDScript 4.x
# 历史遗留: 仍保留旧的动态 UI 兜底逻辑；新增/调整视觉节点请优先改 .tscn。
...
const BOSS_LAYOUT_DEFAULT := {
	...
	"badge_path": "res://assets/images/maps/boss/stage_boss_badge.png",
...
const CHAPTER_BOSS_LAYOUT_OVERRIDES := {
	"chapter_8": {
		...
		"badge_path": "res://assets/images/maps/boss/stage_boss_badge_temporal.png",
...
const CHAPTER_THEME_BACKGROUNDS := {
	"grass": "res://assets/images/maps/backgrounds/stage_map_bg_grass.png",
	"fire": "res://assets/images/maps/backgrounds/stage_map_bg_fire.png",
	"dark": "res://assets/images/maps/backgrounds/stage_map_bg_dark.png",
	"thunder": "res://assets/images/maps/backgrounds/stage_map_bg_thunder.png",
	"ice": "res://assets/images/maps/backgrounds/stage_map_bg_ice.png",
...
const CHAPTER_BOSS_ART := {
	...
	"thunder": "res://assets/images/monsters/boss/monster_boss_005_thunder.png",
	"ice": "res://assets/images/monsters/boss/monster_boss_006_ice.png",
...
func _draw_stage_background() -> void:
	...
	if tex == null:
		tex = _get_texture("res://assets/images/maps/backgrounds/stage_map_bg.png")
	if tex:
...
func _current_chapter_background_path() -> String:
	...
	return str(CHAPTER_THEME_BACKGROUNDS.get(element, "res://assets/images/maps/backgrounds/stage_map_bg.png"))
...
func _draw_chapter_header() -> void:
	...
	_draw_texture_contain(_get_texture("res://assets/images/ui/buttons/stage_ui_back_button.png"), Rect2(9, 12, 56, 56), 0.82 if back_pressed else 1.0)
	_draw_texture_contain(_get_texture("res://assets/images/ui/buttons/stage_icon_back_arrow.png"), Rect2(21, 24, 32, 32))
	
	var header := _get_texture("res://assets/images/ui/bars/stage_ui_header_bar.png")
	if header:
	...
	_draw_texture_contain(_get_texture("res://assets/images/ui/icons/stage_icon_chapter_badge.png"), HEADER_BADGE_RECT)
	_draw_text_center(str(current_num), 103, 41, Color.WHITE, 12, true, 34)
	
	if _current_chapter_index > 0:
		_draw_texture_contain(_get_texture("res://assets/images/ui/buttons/stage_ui_arrow_button.png"), HEADER_PREV_RECT, 0.82 if _touched_btn == "prevChapter" else 1.0)
		_draw_texture_contain(_get_texture("res://assets/images/ui/buttons/stage_icon_prev_arrow.png"), Rect2(HEADER_PREV_RECT.position.x + 6.0, HEADER_PREV_RECT.position.y + 6.0, 22, 22))
	if _current_chapter_index < _chapters.size() - 1:
...
func _draw_path_dots(x1: float, y1: float, x2: float, y2: float) -> void:
	...
	var dot := _get_texture("res://assets/images/maps/nodes/stage_icon_path_dot.png")
