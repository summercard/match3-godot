...
const GUI_ASSETS := {
	...
	"tab_normal": "res://assets/images/ui/buttons/inventory_new_ui_inventory_tab_normal.png",
	...
	"battle": "res://assets/images/ui/icons/common_nav_icon_nav_battle.png",
	...
	"nav_album": "res://assets/images/ui/icons/common_nav_icon_nav_album.png",
	"nav_achievement": "res://assets/images/ui/icons/common_nav_icon_nav_achievement.png",
	"nav_settings": "res://assets/images/ui/icons/common_nav_icon_nav_settings.png",
	"nav_signin": "res://assets/images/ui/icons/common_nav_icon_nav_signin.png",
}
...
func _connect_authored_hit_areas() -> void:
	var paths := [
		...
		"HitAreas/Tabs/TabCollect",
		"HitAreas/Tabs/TabNumeric",
		"HitAreas/Tabs/TabContinuous",
		"HitAreas/BottomNav/HomeButton",
		"HitAreas/BottomNav/AlbumButton",
		"HitAreas/BottomNav/AchievementButton",
		"HitAreas/BottomNav/SettingsButton",
		"HitAreas/BottomNav/SignInButton",
	]
	for path in paths:
...
func _on_authored_hit_area_input(event: InputEvent, control: Control) -> void:
	if event is InputEventMouseButton and event.button_index == MOUSE_BUTTON_LEFT and event.pressed:
		_on_gui_tap(_hit_area_event_to_scene_position(event.position, control))
